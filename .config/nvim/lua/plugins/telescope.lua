...
local function normalize_cwd() return normalize_path(vim.loop.cwd()) .. '/' end

local function is_subdirectory(cwd, path) return string.lower(path:sub(1, #cwd)) == string.lower(cwd) end
...
local function path_display(_, path)
  ...
  if filename == stripped_path or stripped_path == '' then return filename end
